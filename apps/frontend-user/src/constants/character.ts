import charSeed0 from "../assets/char0-seed.png";
...
import charCounsel0 from "../assets/char0-counsel.png";
...
export const CHARACTERS: Record<number, Character> = {
  0: {
    id: 0,
    label: "포근하고 다정한 토닥씨앗",
    images: { seed: charSeed0, counsel: charCounsel0 },
  },
  1: {
    id: 1,
    label: "차분하고 조용한 차곡씨앗",
